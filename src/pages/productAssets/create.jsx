...
function CreateAssts() {
  const navigate = useNavigate();

  const [txtproduct_id, setProduct_id] = useState("");
  ...
  const uploadAssets = async () => {
    ...
    formData.append("product_id", txtproduct_id);
          ...
          <div className="col-md-8 mt-4">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-3 row">
                <label className="col-sm-3">Product ID </label>
